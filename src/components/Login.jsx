...
//       if (data.length > 0) {
//         const user = data[0];
//         localStorage.setItem("loggedUser", JSON.stringify(user)); // save user
//         alert(`Welcome, ${user.username}!`);

//         if (onClose) onClose(); // close modal

//         // SPA redirect if user was coming from another page
//         const redirectPath = localStorage.getItem("redirectAfterLogin");
//         if (redirectPath) {
//           localStorage.removeItem("redirectAfterLogin"); // cleanup
//           navigate(redirectPath); // navigate using SPA routing
//         } else {
